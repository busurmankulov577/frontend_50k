...
var Slider = /*#__PURE__*/function () {
  ...
  _createClass(Slider, [{
    ...
    value: function whoAmI() {
      console.log("Shirina: ".concat(this.width, " Vysota: ").concat(this.height, " Kolichestvo: ").concat(this.count));
    }
  }]);

  return Slider;
}(); // const   slider = new Slider(400, 200, 5),
//         someSlider = new Slider (600, 400,1);
// slider.nextSlide();
// someSlider.whoAmI();
...
var slider = new AutoSlider(400, 200, 5, true); // someSlider = new Slider (600, 400,1);
